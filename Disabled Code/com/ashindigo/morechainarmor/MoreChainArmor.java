...
public class MoreChainArmor {
    ...
    public static ArmorMaterial ARMORCHAINQUARTZ = EnumHelper.addArmorMaterial("QuartzChain", 20, new int[] {2, 5, 4, 3}, 20);
    public static ArmorMaterial ARMORCHAINNETHERSTAR = EnumHelper.addArmorMaterial("NetherStarChain", 20, new int[] {3, 8, 8, 4}, 20);
