...
public class Registry {
	...
	public static void registerRecipes(){
    	...
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(MoreChainArmor.chain,1),
    		"AA ", 
    		"AA ", 
    		"   ", 
    		'A', "nuggetIron"));
    	GameRegistry.addRecipe(new ItemStack(MoreChainArmor.chain,1,1), new Object[]{
        	"AA ",
        	"AA ",
        	"   ",
        	'A', new ItemStack(Items.gold_nugget,1)
    	});
    	GameRegistry.addRecipe(new ItemStack(MoreChainArmor.chain,1,2), new Object[]{
        	"AA ",
        	"AA ",
        	"   ",
        	'A', new ItemStack(MoreChainArmor.nugget,4,2)
    	});
    	GameRegistry.addRecipe(new ItemStack(MoreChainArmor.chain,1,3), new Object[]{
        	"AA ",
        	"AA ",
        	"   ",
        	'A', new ItemStack(MoreChainArmor.nugget,4,3)
    	});
    	GameRegistry.addRecipe(new ItemStack(MoreChainArmor.chain,1,4), new Object[]{
        	"AA ",
        	"AA ",
        	"   ",
        	'A', new ItemStack(MoreChainArmor.nugget,4,4)
    	});
    	GameRegistry.addRecipe(new ItemStack(MoreChainArmor.chain,1,5), new Object[]{
        	"AA ",
        	"AA ",
        	"   ",
        	'A', new ItemStack(MoreChainArmor.nugget,4,5)
    	});
	}

	public static void registerDictionary() {
		
		OreDictionary.registerOre("nuggetIron", new ItemStack(MoreChainArmor.nugget,0,0));
		OreDictionary.registerOre("nuggetDiamond", new ItemStack(MoreChainArmor.nugget,0,2));
		OreDictionary.registerOre("nuggetEmerald", new ItemStack(MoreChainArmor.nugget,0,3));
		OreDictionary.registerOre("nuggetQuartz", new ItemStack(MoreChainArmor.nugget,0,4));
		OreDictionary.registerOre("nuggetNetherStar", new ItemStack(MoreChainArmor.nugget,0,5));
	}
