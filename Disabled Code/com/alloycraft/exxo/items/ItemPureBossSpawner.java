...
public class ItemPureBossSpawner extends ItemMonsterPlacer
{
    ...
    public ItemPureBossSpawner()
    {
        super();
    }
    
    public ItemPureBossSpawner(String parEntityToSpawnName, int parPrimaryColor, 
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
       ...
       {
            entityToSpawnNameFull = Refrences.MODID+"."+entityToSpawnName;
