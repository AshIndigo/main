...
import com.alloycraft.exxo.slots.SlotLunchBox;
...
public final InventoryLunchBox inventory;
...
private static final int INV_START = InventoryLunchBox.INV_SIZE, INV_END = INV_START+26,
...
public ContainerLunchBox(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryLunchBox inventoryItem)
{
...
for (i = 0; i < InventoryLunchBox.INV_SIZE; ++i)
{
...
this.addSlotToContainer(new SlotLunchBox(this.inventory, i, 80 + (18 * (int)(i/4)), 8 + (18*(i%4))));
}
