package com.alloycraft.exxo.tileenties;

import com.alloycraft.exxo.blocks.AlloySmelter;
import com.alloycraft.exxo.blocks.Crystalizer;
import com.alloycraft.exxo.recipes.CrystalizerRecipes;
...
public class TileEntityCrystalizer extends TileEntity implements ISidedInventory {
	...
	private boolean canSmelt() {
		...
		ItemStack itemstack = CrystalizerRecipes.getSmeltingResult(slots[0].getItem(), slots[1].getItem());
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if (flag != this.isSmelting()) {
				flag1 = true;
				Crystalizer.updateBlockState(this.isSmelting(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
