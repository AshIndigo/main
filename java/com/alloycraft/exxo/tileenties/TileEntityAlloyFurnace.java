...
public class TileEntityAlloyFurnace extends TileEntity implements ISidedInventory {
	...
	private boolean canSmelt() {
		...
		ItemStack itemstack = AlloyFurnaceRecipes.getSmeltingResult(slots[0].getItem(), slots[1].getItem());
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if (flag != this.isSmelting()) {
				flag1 = true;
				AlloySmelter.updateBlockState(this.isSmelting(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
