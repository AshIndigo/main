...
public class Crystalizer extends BlockContainer {
	...
	public Crystalizer(boolean blockState) {
		super(Material.iron);
		rand = new Random();
		isActive = blockState;
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Refrences.MODID + ":" + (this.isActive ? "CrystalizerSideOn" : "CrystalizerSideOff"));
		this.iconFront = iconRegister.registerIcon(Refrences.MODID + ":" + (this.isActive ? "CrystalizerFrontOn" : "CrystalizerFrontOff"));
	}
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityPlayer, ItemStack itemstack) {
    	...
    	if(itemstack.hasDisplayName()) {
    		//((TileEntityCrystalizer)world.getTileEntity(x, y, z)).setCustomName(itemstack.getDisplayName());
    	}
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    	if (world.isRemote) {
    		...
    		TileEntityCrystalizer entity = (TileEntityCrystalizer) world.getTileEntity(x, y, z);
    		if (entity != null) {
    			FMLNetworkHandler.openGui(player, Alloycraft.instance, Alloycraft.guiIDCrystalizer, world, x, y, z);
    		}
    		return true;
    	}else{
    		return false;
