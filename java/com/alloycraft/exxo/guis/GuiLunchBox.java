...
public class GuiLunchBox extends GuiContainer {
	...
	public ResourceLocation texture = new ResourceLocation(Refrences.MODID
			+ ":" + "textures/gui/GuiAlloyFurnace.png");
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.fontRendererObj.drawString(I18n.format("Lunch Box"), 26,
