...
public class MusicDisc extends ItemRecord {
	...
	public void registerIcons(IIconRegister iconRegister) {
		itemIcon = iconRegister.registerIcon(Refrences.MODID + "record_"
				+ recordName);
	}
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player,
		...
		if (world.getBlock(x, y, z) == Blocks.jukebox
			...
			if (world.isRemote)
				...
				((BlockJukebox) Blocks.jukebox).func_149926_b(world, x, y, z,
						itemStack);

				world.playAuxSFXAtEntity((EntityPlayer) null, 1005, x, y, z,
